To ensure that the WhatsApp status card fits any screen size, you can use percentage-based widths for the `.whatsapp-status` and `.status-slider` elements. Here's the updated code:
...
In this version, the `.whatsapp-status` div covers the entire screen using percentage-based widths and heights, ensuring that it fits any screen size. The `.status-slider` div retains its relative positioning and is centered within the `.whatsapp-status` div using